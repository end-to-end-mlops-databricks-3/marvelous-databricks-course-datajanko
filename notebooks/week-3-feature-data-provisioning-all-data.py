...
# MAGIC %pip install -e ..
# MAGIC %pip install git+https://github.com/end-to-end-mlops-databricks-3/marvelous@0.3.1
...
all_data_set = spark.table(f"{config.catalog_name}.{config.schema_name}.parsed_data")

# COMMAND ----------

overall_feature_table_name = f"{config.catalog_name}.{config.schema_name}.overall_winning_shares_fe_parsed_timestamp"
per_map_feature_table_name = f"{config.catalog_name}.{config.schema_name}.per_map_winning_shares_fe_parsed_timestamp"
